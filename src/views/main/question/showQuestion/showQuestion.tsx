                    ...
                    <div className="subject-bottom">
                        <div>
                            ...
                            <div className="exam-type">
                                <Select defaultValue="" onChange={this.handleText} style={{ width: 120, margin: "0 11px", height: 30 }}>
                                    {
                        ...
                        <div>
                            ...
                            <div className="exam-type">
                                <Select defaultValue="" onChange={this.handleQuestion} style={{ width: 120, margin: "0 11px", height: 30 }}>
                                    {
